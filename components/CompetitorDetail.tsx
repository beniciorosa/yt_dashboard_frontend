...
import { ArrowLeft, ExternalLink, Calendar, MapPin, Video, Eye, Users, BrainCircuit, Loader2, Trash2, ArrowRightLeft, RefreshCw, AlertTriangle, Flame, Clock, Edit2, Check, X, ThumbsUp, MessageCircle } from 'lucide-react';
...
export const CompetitorDetail: React.FC<Props> = ({ competitorId, onBack }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {showUpdateForm && (
        <UpdateForm onClose={() => setShowUpdateForm(false)} onSave={handleAddUpdate} />
      )}
